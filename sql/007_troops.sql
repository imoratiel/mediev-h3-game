...
CREATE TABLE IF NOT EXISTS armies (
    ...
    rest_level DECIMAL(5,2) DEFAULT 100.00, -- 0 a 100, al llegar a 0 se detiene
    is_resting BOOLEAN DEFAULT FALSE, -- Indica si el ejército está acampado recuperando fuerzas
...
INSERT INTO unit_types (name, attack, health_points, speed, detection_range, gold_upkeep, food_consumption, is_siege, flavor_text) VALUES
...
VALUES ((SELECT id FROM unit_types WHERE name='Milicia'), 'gold', 25);

-- Requisitos para Soldados (Hierro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Soldados'), 'gold', 100),
       ((SELECT id FROM unit_types WHERE name='Soldados'), 'iron_stored', 30);

-- Requisitos para Lanceros (Madera + Hierro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Lanceros'), 'gold', 80),
       ((SELECT id FROM unit_types WHERE name='Lanceros'), 'wood_stored', 20),
       ((SELECT id FROM unit_types WHERE name='Lanceros'), 'iron_stored', 15);

-- Requisitos para Arqueros (Madera)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Arqueros'), 'gold', 120),
       ((SELECT id FROM unit_types WHERE name='Arqueros'), 'wood_stored', 50);

-- Requisitos para Ballesteros (Madera + Hierro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Ballesteros'), 'gold', 150),
       ((SELECT id FROM unit_types WHERE name='Ballesteros'), 'wood_stored', 30),
       ((SELECT id FROM unit_types WHERE name='Ballesteros'), 'iron_stored', 20);

-- Requisitos para Caballería Ligera (Oro alto por caballos)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Caballería Ligera'), 'gold', 250),
       ((SELECT id FROM unit_types WHERE name='Caballería Ligera'), 'wood_stored', 10);

-- Requisitos para Caballería Pesada (Mucho Hierro y Oro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Caballería Pesada'), 'gold', 500),
       ((SELECT id FROM unit_types WHERE name='Caballería Pesada'), 'iron_stored', 100);

-- Requisitos para Explorador (Comida/Oro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Explorador'), 'gold', 100);

-- Requisitos para Ariete (Mucha Madera)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Ariete'), 'gold', 200),
       ((SELECT id FROM unit_types WHERE name='Ariete'), 'wood_stored', 150);

-- Requisitos para Catapulta (Madera, Hierro y Oro)
INSERT INTO unit_requirements (unit_type_id, resource_type, amount) 
VALUES ((SELECT id FROM unit_types WHERE name='Catapulta'), 'gold', 600),
       ((SELECT id FROM unit_types WHERE name='Catapulta'), 'wood_stored', 100),
       ((SELECT id FROM unit_types WHERE name='Catapulta'), 'iron_stored', 50);
...
VALUES 
((SELECT id FROM unit_types WHERE name='Caballería Pesada'), 'Plains', 1.30, 1.00, 1, 0.80),
((SELECT id FROM unit_types WHERE name='Caballería Pesada'), 'Mountain', 0.70, 0.50, -2, 2.00);

-- ARQUEROS: Bonus defensivo enorme en Bosques (Forest).
INSERT INTO unit_terrain_modifiers (unit_type_id, terrain_type, attack_modificator, defense_modificator, speed_modificator, stamina_drain_modificator)
VALUES 
((SELECT id FROM unit_types WHERE name='Arqueros'), 'Forest', 1.20, 1.80, 0, 0.90);

-- INFANTERÍA (Soldados/Lanceros): Estables en Colinas y Montañas.
INSERT INTO unit_terrain_modifiers (unit_type_id, terrain_type, attack_modificator, defense_modificator, speed_modificator, stamina_drain_modificator)
VALUES 
((SELECT id FROM unit_types WHERE name='Lanceros'), 'Mountain', 1.00, 1.40, -1, 1.20),
((SELECT id FROM unit_types WHERE name='Soldados'), 'Mountain', 1.00, 1.30, -1, 1.20);

-- EXPLORADORES: No sufren por el terreno.
INSERT INTO unit_terrain_modifiers (unit_type_id, terrain_type, attack_modificator, defense_modificator, speed_modificator, stamina_drain_modificator)
VALUES 
((SELECT id FROM unit_types WHERE name='Explorador'), 'Forest', 1.00, 1.00, 0, 0.70),
((SELECT id FROM unit_types WHERE name='Explorador'), 'Mountain', 1.00, 1.00, 0, 0.80);
...
VALUES 
((SELECT id FROM unit_types WHERE name='Lanceros'), (SELECT id FROM unit_types WHERE name='Caballería Pesada'), 2.50),
((SELECT id FROM unit_types WHERE name='Lanceros'), (SELECT id FROM unit_types WHERE name='Caballería Ligera'), 2.00);

-- CABALLERÍA vs ARQUEROS/BALLESTEROS (Carga de flanco)
INSERT INTO unit_combat_counters (attacker_type_id, defender_type_id, damage_multiplier)
VALUES 
((SELECT id FROM unit_types WHERE name='Caballería Ligera'), (SELECT id FROM unit_types WHERE name='Arqueros'), 1.80),
((SELECT id FROM unit_types WHERE name='Caballería Pesada'), (SELECT id FROM unit_types WHERE name='Ballesteros'), 2.00);

-- ARQUEROS vs INFANTERÍA (Hostigamiento)
INSERT INTO unit_combat_counters (attacker_type_id, defender_type_id, damage_multiplier)
VALUES 
((SELECT id FROM unit_types WHERE name='Arqueros'), (SELECT id FROM unit_types WHERE name='Milicia'), 1.50),
((SELECT id FROM unit_types WHERE name='Arqueros'), (SELECT id FROM unit_types WHERE name='Soldados'), 1.30);

-- BALLESTEROS vs CABALLERÍA PESADA (Penetración de armadura)
INSERT INTO unit_combat_counters (attacker_type_id, defender_type_id, damage_multiplier)
VALUES 
((SELECT id FROM unit_types WHERE name='Ballesteros'), (SELECT id FROM unit_types WHERE name='Caballería Pesada'), 1.60);
